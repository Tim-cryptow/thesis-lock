...
const PAGES: PaletteItem[] = [
  { id: "anchor", title: "Anchor", description: "/anchor", icon: "anchor", path: "/anchor", shortcut: "N", section: "pages" },
  { id: "anchors", title: "My Anchors", description: "/anchors", icon: "history", path: "/anchors", shortcut: "H", section: "pages" },
  { id: "verify", title: "Verify", description: "Verify a document by hash, wallet, or label", icon: "shield", path: "/search", section: "pages" },
  ...
  { id: "watchlist", title: "Watchlist", description: "/watchlist", icon: "shield", path: "/watchlist", section: "pages" },
  ...
  { id: "verify-bulk", title: "Bulk Verify", description: "/verify-bulk", icon: "shield", path: "/verify-bulk", section: "pages" },
  { id: "templates", title: "Templates", description: "/templates", icon: "doc", path: "/templates", section: "pages" },
  { id: "developers", title: "Developers", description: "/developers", icon: "code", path: "/developers", section: "pages" },
  { id: "docs", title: "Docs", description: "/docs", icon: "doc", path: "/docs", shortcut: "D", section: "pages" },
