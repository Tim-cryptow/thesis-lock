  ...
  return (
    <div>
      ...
      <P>
        ...
        everywhere in the app, replacing the assorted one-off copy buttons that
        had grown inconsistent over time.
      </P>
      <List
        items={[
          <>
            A single copy control with a clipboard icon that switches to a
            checkmark, plus a brief &quot;Copied!&quot; tooltip.
          </>,
          <>
            Truncated hashes and addresses share one component: a compact
            display, the full value on hover, click-to-copy, and a profile link
            for addresses.
          </>,
          <>
            A global toast confirms every copy at the bottom of the screen and
