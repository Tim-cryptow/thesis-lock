...
- Interactive [API Playground](https://thesis-lock.vercel.app/developers) at `/developers`: pick any endpoint, fill in parameters, send live requests, and see the response with a matching copy-ready curl command.
